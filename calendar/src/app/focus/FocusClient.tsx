...
export default function FocusClient({ queue }: { queue: FocusTask[] }) {
  ...
  return (
    <div className="mt-10 flex flex-col items-center gap-8">
      <div className="w-full rounded-2xl border border-zinc-200 bg-white p-6 text-center shadow-sm ring-1 ring-black/5 dark:border-zinc-800 dark:bg-zinc-900">
        ...
        <div className="mt-2 flex flex-wrap items-center justify-center gap-1.5 text-xs text-zinc-500">
          <span className="inline-flex items-center rounded-full bg-zinc-100 px-2 py-0.5 dark:bg-zinc-800">
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="rounded-lg border border-zinc-200 bg-white px-4 py-2.5 text-sm font-medium text-zinc-700 shadow-sm transition-colors hover:bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-300 dark:hover:bg-zinc-800/60"
        >
          Reset
        </button>
      </div>
