...
export default function TopBar() {
  ...
  return (
    <header className="sticky top-0 z-30 flex shrink-0 items-center justify-between gap-2 overflow-x-auto border-b border-zinc-200 bg-white/90 px-3 py-2.5 shadow-sm backdrop-blur sm:gap-4 sm:px-4 dark:border-zinc-700 dark:bg-zinc-900/90">
