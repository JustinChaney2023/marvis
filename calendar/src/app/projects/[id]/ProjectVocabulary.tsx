  ...
  return (
    <div className="mt-2 flex flex-col gap-2">
      <textarea
        ...
        className="w-full rounded-lg border border-rule bg-surface px-3 py-2 text-sm text-ink transition-colors focus:border-accent focus:outline-none"
      />
      ...
      {promptPreview && (
        <details className="text-xs text-muted">
          ...
          <p className="mt-1 rounded-lg bg-rule-soft p-2 text-ink-2">
            {promptPreview}
          </p>
          <p className="mt-1">
