 ...
 * link, or — via the nav bar with no eventId — whatever's on right now
 * (e.g. "start my current class's timer"). Falls back to a plain
 * 25-minute pomodoro when nothing's in progress.
 */
