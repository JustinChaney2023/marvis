...
INSERT INTO "new_Event" ("allDay", "appleEventUid", "color", "createdAt", "end", "googleEventId", "googleUpdatedAt", "habitId", "id", "localDirty", "locked", "meetingUrl", "notes", "recurrenceRule", "source", "start", "subscriptionEventUid", "subscriptionId", "taskId", "title", "updatedAt", "userId") SELECT "allDay", "appleEventUid", "color", "createdAt", "end", "googleEventId", "googleUpdatedAt", "habitId", "id", "localDirty", "locked", "meetingUrl", "notes", "recurrenceRule", "source", "start", "subscriptionEventUid", "subscriptionId", "taskId", "title", "updatedAt", "userId" FROM "Event";
DROP TABLE "Event";
